        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-lg text-slate-900 max-w-4xl">
              Un recorrido por el territorio: observación, análisis, propuestas y saberes de la economía popular del barrio la Magnolia,Envigado.
            </p>
          </div>
          <div className="text-sm text-slate-500 whitespace-nowrap overflow-x-auto">
            Creado por DIANA ARTEMISA ARBELAEZ ARBELÁEZ.  
                  </div>
        </div>
      </div>
    </header>
