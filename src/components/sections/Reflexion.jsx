...
export default function Bibliografia() {
  ...
  return (
    <div ref={container} className="bg-white p-8 lg:p-10 rounded-[32px] shadow-sm border border-slate-100 animate-fadeIn space-y-10" style={{ borderLeft: '8px solid #a855f7' }} data-anime>
