    ...
    <div ref={container} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 animate-fadeIn space-y-8" data-anime>
      ...
      <div>
        ...
        <p className="text-slate-600 text-lg mt-4 max-w-3xl">
          A través de caminatas territoriales sistemáticas y el diálogo activo con los habitantes, hemos construido una <strong>Bitácora de Observación</strong> para capturar las cápsulas audiovisuales, notas de campo y fotografías que sustentan el diagnóstico social de la economía popular.
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 mt-8">
        ...
        <h3 className="text-xl font-bold text-slate-800">Extractos de la Bitácora de Campo de las Investigadoras</h3>
      </div>
