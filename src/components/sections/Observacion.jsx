...
export default function Observacion() {
  ...
  return (
    <div ref={container} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 animate-fadeIn space-y-8" style={{ borderLeft: '8px solid #a855f7' }} data-anime>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-bold text-purple-700 uppercase tracking-wider">Observación- Trabajo de campo</span>
        </div>
        <h2 className="text-3xl font-bold text-slate-900">Observación Activa e Instrumentos</h2>
      ...
      <div className="grid gap-6 md:grid-cols-3" data-anime>
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col justify-between">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200">
            ...
            <p className="px-4 py-3 text-[11px] text-slate-500 italic leading-relaxed">
              Fotografias tomadas por recorrido satelital, de googlemaps, tomadas del barrio La Magnolia- Envigado
            </p>
          </div>
        </div>
