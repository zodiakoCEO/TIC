...
export default function Analisis() {
  ...
  return (
    <div ref={container} className="bg-white p-8 lg:p-10 rounded-[32px] shadow-sm border border-slate-100 animate-fadeIn space-y-12" style={{ borderLeft: '8px solid #a855f7' }} data-anime>
      ...
      <div className="space-y-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-bold text-purple-700 uppercase tracking-wider">Análisis</span>
          </div>
            ...
            <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "Uso de billeteras digitales (Nequi, Bancolombia, DaviPlata etc...) ", score: 90 }
                ].map((item, i) => (
                  <div key={i}>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="flex flex-col rounded-3xl border border-slate-100 bg-white min-h-[300px]">
              ...
              <p className="px-4 py-3 text-[11px] text-slate-500 italic leading-relaxed bg-white border-t border-slate-100">
                Fotografías Propias, Tomadas en el Barrio la Magnolia, Envigado. Año 2026- Collage apoyado de la IA copilot
              </p>
            </div>
