...
const plataformas = [
  ...
  {
    nombre: 'Platzi',
    temas: 'Emprendimiento, marketing digital, diseño, productividad',
    publico: 'Jóvenes, emprendedores, comerciantes',
    certificacion: 'Sí',
    costo: 'Gratis y de pago',
    url: 'https://platzi.com',
    label: 'Ver cursos Platzi',
  },
];
...
const fases = [
  ...
  },
  {
    ...
    descripcion: 'Acceso a clientes locales y foráneos a través del mapa interactivo con directorio telefónico que estara disponible en el micrositio.',
  },
];
...
export default function Propuesta() {
  ...
  return (
    <div
      ref={container}
      className="bg-white p-8 rounded-2xl shadow-sm animate-fadeIn space-y-10"
    ...
    >
      ...
      <div data-anime>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-sm font-bold text-purple-700 uppercase tracking-wider">Propuesta</span>
        </div>
