...
export default function Inicio({ setActiveTab }) {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-2" style={{ borderLeft: '8px solid #a855f7' }}>
