...
import Barrio1 from '../../../public/barrio1.jpeg';
import comunidad1 from '../../../public/comunidad1.png';
import comunidad2 from '../../../public/comunidad2.png';
...
export default function Territorio() {
  ...
  return (
    <div ref={container} className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-8 lg:p-12 rounded-[32px] shadow-sm border border-slate-100" style={{ borderLeft: '8px solid #a855f7' }} data-anime>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 flex flex-col justify-center hover:shadow-md transition-shadow" data-anime>
            <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-5 border border-slate-100 p-2 overflow-hidden">
              <img src={comunidad1} alt="Icono Redes Comunitarias" className="w-full h-full object-contain opacity-80" />
            </div>
          ...
          <div className="rounded-3xl overflow-hidden border border-slate-200 group" data-anime>
            <img
              src={comunidad1}
            ...
            />
            <p className="px-4 py-3 text-[11px] text-slate-500 italic leading-relaxed bg-white border-t border-slate-100">
              Collage a partir de Fotografía propias, con apoyo de diseño de la IA Copilot. Tomadas en el año 2026.
            </p>
          </div>
