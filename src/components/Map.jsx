...
const emprendimientosIniciales = [
  ...
  { nombre: 'Foto Duran_Fotos,Papeleria y fotocopiadora', lat: 6.174844, lng: -75.581552, whatsapp: '+57 60442704661' },
  {nombre: 'Jonathan Hats_ Fábrica de Sombreros', lat: 6.1749028, lng: -75.584155, whatsapp: '+57 6043866195' },
  {nombre: 'Carpinteria las dos Palmas', lat: 6.174263, lng: -75.581383, whatsapp: '+57 604232090' },
  {nombre: 'Masajes y Spa', lat: 6.174096, lng: -75.581966, whatsapp: '+57 3148935189' },
  {nombre: 'Papeleria y variedades Rios', lat: 6.172972, lng: -75.581435, whatsapp: '+57 3113411264' },
  {nombre: 'Arquitectura desde Casa- Sensitivo Arquitectura', lat: 6.172546, lng: -75.581377, whatsapp: '+57 3016050710' },
  {nombre: 'Manteca de Cerdo, Receta natural', lat: 6.172501, lng: -75.581572, whatsapp: '+57 0000' },
  {nombre: 'La Sastrería de Don Jairo', lat: 6.172602, lng: -75.583090, whatsapp: '+57 60400000' },
  {nombre: 'Muebles y Tapiceria_ Carlos y Leonardo', lat: 6.173463, lng: -75.584165, whatsapp: '+57 3025661549' },
  {nombre: 'JB Aperos Equinos- Artesano Jaime', lat: 6.1750397, lng: -75.5846743, whatsapp: '+57 3108991648' },
  {nombre: 'Postres Caseros pos3', lat: 6.172012, lng: -75.583621, whatsapp: '+57 3217000153' },
];
  ...
  return (
    <div className="w-full min-h-[520px] rounded-[28px] overflow-hidden border border-slate-200 shadow-glow relative bg-slate-100 flex flex-col items-center justify-center">
      ...
      <div className="absolute bottom-4 left-4 right-4 z-20">
        <p className="text-[11px] text-slate-500 italic bg-white/90 backdrop-blur-sm rounded-lg px-3 py-2 border border-slate-200">
          Mapa interactivo del territorio. Fuente: mapa propio con derechos de uso adquiridos para su reproducción en este proyecto.
        </p>
      </div>
    </div>
  );
